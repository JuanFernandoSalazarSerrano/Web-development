...
__name(getCreateEffectMetadata, "getCreateEffectMetadata");
...
__name(getEffectsMetadata, "getEffectsMetadata");
function getSourceMetadata(instance) {
  return getCreateEffectMetadata(instance);
}
__name(getSourceMetadata, "getSourceMetadata");
...
__name(mergeEffects, "mergeEffects");
...
__name(defaultEffectsErrorHandler, "defaultEffectsErrorHandler");
...
_Actions.ɵfac = /* @__PURE__ */ __name(function Actions_Factory(__ngFactoryType__) {
...
var EFFECTS_ERROR_HANDLER = new InjectionToken("@ngrx/effects Effects Error Handler", {
  providedIn: "root",
  factory: /* @__PURE__ */ __name(() => defaultEffectsErrorHandler, "factory")
});
...
__name(reportInvalidActions, "reportInvalidActions");
...
__name(getEffectName, "getEffectName");
...
__name(isOnIdentifyEffects, "isOnIdentifyEffects");
var onRunEffectsKey = "ngrxOnRunEffects";
function isOnRunEffects(instance) {
  return isFunction(instance, onRunEffectsKey);
}
__name(isOnRunEffects, "isOnRunEffects");
var onInitEffects = "ngrxOnInitEffects";
function isOnInitEffects(instance) {
  return isFunction(instance, onInitEffects);
}
__name(isOnInitEffects, "isOnInitEffects");
...
__name(_EffectSources, "EffectSources");
_EffectSources.ɵfac = /* @__PURE__ */ __name(function EffectSources_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _EffectSources)(ɵɵinject(ErrorHandler), ɵɵinject(EFFECTS_ERROR_HANDLER));
}, "EffectSources_Factory");
...
__name(effectsInstance, "effectsInstance");
...
__name(resolveEffectSource, "resolveEffectSource");
...
__name(_EffectsRunner, "EffectsRunner");
_EffectsRunner.ɵfac = /* @__PURE__ */ __name(function EffectsRunner_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _EffectsRunner)(ɵɵinject(EffectSources), ɵɵinject(Store));
}, "EffectsRunner_Factory");
...
__name(_EffectsRootModule, "EffectsRootModule");
_EffectsRootModule.ɵfac = /* @__PURE__ */ __name(function EffectsRootModule_Factory(__ngFactoryType__) {
...
__name(_EffectsFeatureModule, "EffectsFeatureModule");
_EffectsFeatureModule.ɵfac = /* @__PURE__ */ __name(function EffectsFeatureModule_Factory(__ngFactoryType__) {
...
__name(_EffectsModule, "EffectsModule");
_EffectsModule.ɵfac = /* @__PURE__ */ __name(function EffectsModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _EffectsModule)();
}, "EffectsModule_Factory");
...
__name(createEffectsInstances, "createEffectsInstances");
...
__name(provideEffects, "provideEffects");
export {
  Actions,
