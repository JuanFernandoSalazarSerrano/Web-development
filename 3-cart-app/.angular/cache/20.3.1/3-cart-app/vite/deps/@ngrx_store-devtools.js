...
var _PerformAction = class _PerformAction {
...
__name(_PerformAction, "PerformAction");
var PerformAction = _PerformAction;
var _Refresh = class _Refresh {
  constructor() {
    this.type = REFRESH;
  }
};
__name(_Refresh, "Refresh");
var Refresh = _Refresh;
var _Reset = class _Reset {
...
__name(_Reset, "Reset");
var Reset = _Reset;
var _Rollback = class _Rollback {
  constructor(timestamp) {
    this.timestamp = timestamp;
    this.type = ROLLBACK;
  }
};
__name(_Rollback, "Rollback");
var Rollback = _Rollback;
var _Commit = class _Commit {
  constructor(timestamp) {
    this.timestamp = timestamp;
    this.type = COMMIT;
  }
};
__name(_Commit, "Commit");
var Commit = _Commit;
var _Sweep = class _Sweep {
  constructor() {
    this.type = SWEEP;
  }
};
__name(_Sweep, "Sweep");
var Sweep = _Sweep;
var _ToggleAction = class _ToggleAction {
  constructor(id) {
    this.id = id;
    this.type = TOGGLE_ACTION;
  }
};
__name(_ToggleAction, "ToggleAction");
var ToggleAction = _ToggleAction;
var _JumpToState = class _JumpToState {
  constructor(index) {
    this.index = index;
    this.type = JUMP_TO_STATE;
  }
};
__name(_JumpToState, "JumpToState");
var JumpToState = _JumpToState;
var _JumpToAction = class _JumpToAction {
  constructor(actionId) {
    this.actionId = actionId;
    this.type = JUMP_TO_ACTION;
  }
};
__name(_JumpToAction, "JumpToAction");
var JumpToAction = _JumpToAction;
var _ImportState = class _ImportState {
  constructor(nextLiftedState) {
    this.nextLiftedState = nextLiftedState;
    this.type = IMPORT_STATE;
  }
};
__name(_ImportState, "ImportState");
var ImportState = _ImportState;
var _LockChanges = class _LockChanges {
  constructor(status) {
    this.status = status;
    this.type = LOCK_CHANGES;
  }
};
__name(_LockChanges, "LockChanges");
var LockChanges = _LockChanges;
var _PauseRecording = class _PauseRecording {
  constructor(status) {
    this.status = status;
    this.type = PAUSE_RECORDING;
  }
};
__name(_PauseRecording, "PauseRecording");
var PauseRecording = _PauseRecording;
var _StoreDevtoolsConfig = class _StoreDevtoolsConfig {
  constructor() {
    this.maxAge = false;
  }
};
__name(_StoreDevtoolsConfig, "StoreDevtoolsConfig");
var StoreDevtoolsConfig = _StoreDevtoolsConfig;
...
__name(unliftState, "unliftState");
function liftAction(action) {
  return new PerformAction(action, +Date.now());
}
__name(liftAction, "liftAction");
...
__name(sanitizeActions, "sanitizeActions");
function sanitizeAction(actionSanitizer, action, actionIdx) {
  return __spreadProps(__spreadValues({}, action), {
    action: actionSanitizer(action.action, actionIdx)
  });
}
__name(sanitizeAction, "sanitizeAction");
...
__name(sanitizeStates, "sanitizeStates");
...
__name(shouldFilterActions, "shouldFilterActions");
...
__name(filterLiftedState, "filterLiftedState");
...
__name(isActionFiltered, "isActionFiltered");
...
__name(injectZoneConfig, "injectZoneConfig");
var _DevtoolsDispatcher = class _DevtoolsDispatcher extends ActionsSubject {
};
__name(_DevtoolsDispatcher, "DevtoolsDispatcher");
_DevtoolsDispatcher.ɵfac = /* @__PURE__ */ (() => {
  let ɵDevtoolsDispatcher_BaseFactory;
  return /* @__PURE__ */ __name(function DevtoolsDispatcher_Factory(__ngFactoryType__) {
...
__name(_DevtoolsExtension, "DevtoolsExtension");
_DevtoolsExtension.ɵfac = /* @__PURE__ */ __name(function DevtoolsExtension_Factory(__ngFactoryType__) {
...
__name(computeNextEntry, "computeNextEntry");
...
__name(recomputeStates, "recomputeStates");
...
__name(liftInitialState, "liftInitialState");
function liftReducerWith(initialCommittedState, initialLiftedState, errorHandler, monitorReducer, options = {}) {
  return (reducer) => (liftedState, liftedAction) => {
    ...
    __name(commitExcessActions, "commitExcessActions");
...
__name(liftReducerWith, "liftReducerWith");
...
__name(_StoreDevtools, "StoreDevtools");
_StoreDevtools.ɵfac = /* @__PURE__ */ __name(function StoreDevtools_Factory(__ngFactoryType__) {
...
function emitInZone({
  ...
  return (source) => connectInZone ? new Observable((subscriber) => source.subscribe({
    next: /* @__PURE__ */ __name((value) => ngZone.run(() => subscriber.next(value)), "next"),
    error: /* @__PURE__ */ __name((error) => ngZone.run(() => subscriber.error(error)), "error"),
    complete: /* @__PURE__ */ __name(() => ngZone.run(() => subscriber.complete()), "complete")
  })) : source;
}
__name(emitInZone, "emitInZone");
...
__name(createIsExtensionOrMonitorPresent, "createIsExtensionOrMonitorPresent");
...
__name(createReduxDevtoolsExtension, "createReduxDevtoolsExtension");
function createStateObservable(devtools) {
  return devtools.state;
}
__name(createStateObservable, "createStateObservable");
...
__name(provideStoreDevtools, "provideStoreDevtools");
...
__name(_StoreDevtoolsModule, "StoreDevtoolsModule");
_StoreDevtoolsModule.ɵfac = /* @__PURE__ */ __name(function StoreDevtoolsModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _StoreDevtoolsModule)();
}, "StoreDevtoolsModule_Factory");
